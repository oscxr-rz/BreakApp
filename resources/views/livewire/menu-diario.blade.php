<div>
    <!-- Header Superior -->
    <header class="mb-4 bg-[#951327] px-4 py-4 lg:px-6 lg:py-5">
        <div class="flex items-center justify-between mb-4">
            <!-- Logo -->
            <div class="flex items-center gap-2 lg:gap-3">
                <div class="w-10 h-10 lg:w-12 lg:h-12 rounded-full flex items-center justify-center">
                    <img src="{{ asset('storage/logos/1.png') }}" alt="Logo">
                </div>
                <span class="font-semibold text-lg lg:text-xl text-[#FBE8DA]">BreakApp</span>
            </div>
            ...
            <div class="flex items-center gap-2 lg:gap-3">
                ...
                <a href="{{ route('notificaciones') }}"
                    class="w-10 h-10 lg:w-11 lg:h-11 flex items-center justify-center hover:bg-white/10 rounded-full transition-colors">
                    <svg class="w-6 h-6 lg:w-7 lg:h-7 text-[#FBE8DA]" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                ...
                <a href="{{ route('carrito') }}"
                    class="relative w-10 h-10 lg:w-11 lg:h-11 flex items-center justify-center hover:bg-white/10 rounded-full transition-colors">
                    <svg class="w-6 h-6 lg:w-7 lg:h-7 text-[#FBE8DA]" fill="none" stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Fecha -->
        <div class="flex items-center gap-2 text-sm lg:text-base text-[#FBE8DA]/80 mb-4">
        ...
        <div class="relative">
            <input type="text" placeholder="Buscar productos..." id="buscarInput"
                class="w-full bg-white/10 rounded-xl lg:rounded-2xl px-4 py-3 lg:py-3.5 pl-11 lg:pl-12 text-sm lg:text-base border-none focus:ring-2 focus:ring-[#FBE8DA]/50 transition-all text-[#FBE8DA] placeholder-[#FBE8DA]/60">
            <svg class="w-5 h-5 lg:w-6 lg:h-6 absolute left-3 lg:left-4 top-1/2 -translate-y-1/2 text-[#FBE8DA]/70"
    ...
    <div class="w-full px-4 md:px-6 lg:px-8 py-6">
        @if (!empty($menu))
            ...
            <div id="sinResultados" class="hidden flex-col items-center justify-center py-20 lg:py-32">
                <div
                    class="w-32 h-32 lg:w-40 lg:h-40 bg-[#f2cc88]/20 rounded-full flex items-center justify-center mb-6">
